...
function footer() {
  return (
    //helpbox-container
    <div className="bg-[#005c95] flex lg:flex-row py-[15px] pl-[30px] pr-[15px] md:mx-[30px] md:w-auto md:rounded-lg md:m-[30px] ">
      <div className="flex-col relative w-full h-full ">
        <div className="text-white text-[19px] sm:text-[32px] mb-[20px] leading-[36px] self-baseline font-medium tracking-[-0.4px] ">
          Yardıma mı ihtiyacın var?
        </div>
        <div className="relative mx-auto flex flex-col md:flex-row md:gap-8">
